    ...
    describe('POST', ()=>{
        describe('Unauthorized', ()=>{
            it('Should respond with a 401 status', (done) => {
                request(app).post('/api/posts').then((res) => {
        ...
        describe('Authorized', ()=>{
            ...
            it('Should respond with a 400 status if no body provided', (done) => {
                request(app).post('/api/posts').set('x-auth', token).then((res) => {
            ...
            it('Should respond with a 201 status if body provided', (done) => {
                request(app).post('/api/posts').send({"body": "test" }).set('x-auth', token).then((res) => {
            ...
            it('Should add a new post to database if body provided', (done)=>{
                request(app).post('/api/posts').send({"body": "test" }).set('x-auth', token)
